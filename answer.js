...
function subwaySystem(startLine, startStop, endLine, endStop) {
    ...
    if(!startLine.includes(startStop)){
        ...
        return console.log('we can\'t find your start destination. Enter your destination');

    }

    if(!endLine.includes(endStop)){

        return console.log(' we can\'t find your end destination. Enter your destination');
