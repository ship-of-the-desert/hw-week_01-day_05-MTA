...
console.log('You must travel through the following stops on the '+ string_array +' line : '+ stops + Final_stop+ ".");
console.log(`${i} stops in total.`);

}
else //when the trip is changes the line
...
console.log("You must travel through the following stops on the "+ string_array+" line : " + stops + "Union Square.");
